// === Abstract Algebra - Core Application ===
...
const App = {
    ...
    // --- Progress ---
    loadProgress() {
        try { this.progress = JSON.parse(localStorage.getItem('abstract-algebra-progress') || '{}'); }
        catch (e) { this.progress = {}; }
    },
    saveProgress() {
        try { localStorage.setItem('abstract-algebra-progress', JSON.stringify(this.progress)); } catch (e) {}
    },
